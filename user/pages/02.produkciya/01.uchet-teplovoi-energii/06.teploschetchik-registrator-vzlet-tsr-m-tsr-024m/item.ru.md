...
Теплосчетчик-регистратор `ВЗЛЕТ ТСР-М` исполнения `ТСР-024М` комплектуется на базе тепловычислителя `ВЗЛЕТ ТСРВ` (включен в Государственный реестр средств измерений за № 27010-04) исполнения `ТСРВ-024М`. Разработан при участии предприятия «Энергосбыт» ОАО «ТГК-1», ГУП «ТЭК СПб».
