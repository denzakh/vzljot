---
title: 'Теплосчетчик-регистратор  ВЗЛЕТ ТСР-М  (ТСР-026М)'
media_order: tsr-026.jpg
---

Оптимальный выбор для объектов ЖКХ.

Теплосчетчик-регистратор ВЗЛЕТ ТСР-М исполнения ТСР-026М комплектуется на базе тепловычислителя ВЗЛЕТ ТСРВ (включен в Государственный реестр средств измерений за № 27010-04) исполнения ТСРВ-026М, ниже приведены его характеристики.
